...
public class UIManager : MonoBehaviour
{
	...
	[SerializeField] private TabButton boxButton;
	[SerializeField] private InventoryManager inventory;
	[SerializeField] private MarketManager market;
	[SerializeField] private BoxPanel boxPanel;
	...
	private void Start()
	{
		...
		boxButton.OnTabSelected.AddListener(AccessBoxPanel);
	...
	public void AllowUIAccess(bool allow)
	{
		...
		boxButton.gameObject.SetActive(allow);
	}
